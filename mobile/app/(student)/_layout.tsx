...
export default function StudentLayout() {
  const { notifications, messages, currentUser } = useStore();
  ...
  return (
    <Tabs screenOptions={{
      ...
      <Tabs.Screen name="dashboard" options={{ title: 'الرئيسية', tabBarIcon: ({ color, size }) => <Ionicons name="home-outline" size={size} color={color} /> }} />
      <Tabs.Screen name="courses/index" options={{ title: 'كورساتي', tabBarIcon: ({ color, size }) => <Ionicons name="book-outline" size={size} color={color} /> }} />
